...
## Task 1. Implementation of the string.h library functions
...
## Task 2. Partial implementation of the sprintf function

- All of the requirements outlined in Information are applied to function implementation.
...
## Task 3. Implementation of some format modifiers of the sprintf function

It is necessary to implement some format modifiers of the sprintf function from the stdio.h library:
...
## Task 4. Implementation of special string processing functions

You must implement some string processing functions from the String class (described  in Information):
